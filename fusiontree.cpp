...
const big_int fusiontree::mem_val() const{
	
	return mem;
}

// returns the mask sketch_mask
const big_int fusiontree::sketch_mask_val() const{
	
	return sketch_mask;
}

// returns the value of r
const int fusiontree::r_val() const{
	
	return r;
}

// returns the value of b
const big_int fusiontree::b_val() const{
	
	return b;
}

// returns the value of b_i
const int fusiontree::b_pos(int i) const{
	
	return ibit[i];
}

// returns the value of m
const big_int fusiontree::m_val() const{
	
	return m;
}

// returns the value of m_i
const int fusiontree::m_pos(int i) const{
	
	return m_idx[i];
}

// returns the number of integers stored
const int fusiontree::size() const{
	
	return sz;
}

// returns the number in a given position in the tree
const big_int fusiontree::pos(int i) const{
	
	return v[i];
}

// return a bitmask with all the important bits turned on
const big_int fusiontree::important_bits() const{
