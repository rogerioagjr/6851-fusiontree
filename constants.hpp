...
#define WVAR 256  // Value of w, the maximum number of bits of an element of a fusion tree
#define PSIZE 512  // Number of bits printed in cout << big_int
...
#define WVAR 3136  // Value of w, the maximum number of bits of an element of a fusion tree
